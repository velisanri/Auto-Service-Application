...
namespace PersonelService.Data
{
    public class DatabaseContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("server=.\\SQLEXPRESS;database=PersonelService;integrated security=true;TrustServerCertificate=True;");
